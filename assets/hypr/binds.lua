...
hl.bind(mainMod .. " + TAB", function()
    ...
    for i, l in ipairs(layouts) do
        if l == current then idx = i break end -- why is lua so stupid man 😭
    end
...
hl.bind("Print", hl.dsp.exec_cmd('ironbar var set show_weather false; grim - | satty --fullscreen -f - --copy-command wl-copy -o "~/Pictures/Screenshots/%Y%m%d_%H%M%S.png"; ironbar var set show_weather true'))
